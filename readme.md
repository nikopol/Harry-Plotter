...
samples can be viewed [here](https://nikopol.github.io/Harry-Plotter/#tab=presets)
a generator, that let's you play with all parameters can be used [here](https://nikopol.github.io/Harry-Plotter/#tab=generator)
