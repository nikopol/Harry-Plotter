...
/*
	...
	options={
		...
		color: "112233" or [..],      //dataset color, if multi set color must be an array, default=a modulo from default harry colors 
		...
		labels: {                     //labels options
			...
			x: ['label 1','label 2',etc]//x legend using value keys, all=print all raw keys, date=draw key as date, 
...
var harry=function(o) {
	...
	if(o.canvas) {
		...
		this.canvas.setAttribute('width',o.width+'px');
		this.canvas.setAttribute('height',o.height+'px');
	} else
		return alert("you must give a container or a canvas to harry");
