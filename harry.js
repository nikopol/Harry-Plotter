...
var h=harry({
   ...
   labels: {                     //axis labels options
      ...
      yabr: false,               //  y labels abbreviated (eg. 1200 becomes 1.2K)
...
//TOOLS LIB ===================================================================
   ...
   smallNum=function(n){
     return n>1000000 ? (Math.floor(n/100000)/10)+"M" : ( n>1000 ? (Math.floor(n/100)/10)+"K" : n );
   },
   ...
   buildCanvas=function(o,w,h) {
      var c=document.createElement('canvas'),
          p=o?(typeof(o)=='string'?document.getElementById(o):o):document.body;
      if(!p) return;
      c.setAttribute('width',(w||p.clientWidth)+'px');
      c.setAttribute('height',(h||p.clientHeight)+'px');
      p.appendChild(c);
      return c;
   },
...
//PRIVATE VARS ================================================================
   ...
   canvas=o.canvas
      ...
      : buildCanvas(o.container,o.width,o.height),
   w=canvas.width,
   h=canvas.height,
