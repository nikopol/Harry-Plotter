...
100),this.gc.beginPath(),this.gc.moveTo(c,this.ry),this.gc.lineTo(c,this.ry2),this.gc.stroke()}if(this.grid.y){a=0;for(b=this.grid.y.length;a<b;++a)c=this.ry2-Math.round(this.rh*this.grid.y[a]/100),this.gc.beginPath(),this.gc.moveTo(this.rx,c),this.gc.lineTo(this.rx2,c),this.gc.stroke()}}return this},drawYLabels:function(){if(this.dlen&&this.labels.y&&this.gc.font)if(/chart|line|curve/.test(this.mode)){var a=/\:[r|s]/.test(this.mode)?this.dsum:this.dmax,b,c,f,d,j,e=10>a?100:100>a?10:1,g=Math.floor(this.labels.fontpx/
2.5);this.gc.font=this.labels.font;this.gc.fillStyle=this.labels.color;this.gc.textAlign="left";b=0;for(c=this.labels.y.length;b<c;++b)f=this.rx2+1,d=this.ry2-Math.round(this.rh*this.labels.y[b]/100),j=Math.round(e*a*this.labels.y[b]/100)/e,this.gc.fillText(j,f,d+g)}else/pie/.test(this.mode);return this},drawXLabel:function(a,b,c,f,d){this.gc.font&&(this.labels.x&&0==a%this.labels.x)&&(a=this.dataset[0].lab[a]||a,this.gc.font=this.labels.font,this.gc.fillStyle=this.labels.color,this.gc.textAlign=
f||"center",this.gc.textBaseline=d||"alphabetic",this.gc.fillText(a,b,c));return this},drawBullet:function(a,b,c,f,d,j){this.gc.font=this.mouseover.font;var e,g,i=0;e=this.dataset[j].lab[d];var d=("function"==typeof this.mouseover.text?this.mouseover.text(d,f,a,b):this.mouseover.text.replace("%v",f).replace("%l",e).replace("%n",d)).split(/\n|\\n/),f=harryTools.fontPixSize(this.mouseover.font)+3,k=3+d.length*f,l=Math.floor(k/2);for(g in d)e=this.gc.measureText(d[g]).width+6,e>i&&(i=e);e=a+c;g=e+i;
if(g>=this.rw||j%2&&0<a-c-i)g=a-c,e=g-i;b+=l;a=b-k;b>=this.rh?(b=this.rh-0.5,a=b-k):0>a&&(a=1.5,b=a+k);this.gc.beginPath();this.gc.moveTo(e,b);this.gc.lineTo(g,b);this.gc.lineTo(g,a);this.gc.lineTo(e,a);this.gc.closePath();this.gc.fillStyle=this.mouseover.bullet;this.gc.fill();this.gc.lineWidth=1;this.gc.lineJoin="round";this.gc.strokeStyle=this.mouseover.border;this.gc.stroke();this.gc.textAlign="left";this.gc.textBaseline="top";this.gc.fillStyle=this.mouseover.color;g=0;for(a+=3;g<d.length;++g,
a+=f)this.gc.fillText(d[g],e+3-1,a);return this},pie:function(){var a=this.dlen;if(a){var b=0,c=[],f=[],d=2*Math.PI,j=[],e=/percent/.test(this.labels.x);if(1<a){for(var g=0,b=a,a=0;a<b;a++)g+=this.dataset[a].avg;if(g)for(a=0;a<b;a++)c[a]=this.dataset[a].avg/g*d,f[a]=this.dataset[a].col,j.push(e?Math.round(100*this.dataset[a].avg/g)+"%":this.dataset[a].avg.toString())}else if(g=this.dataset[0],g.sum){b=g.len;for(a=0;a<b;a++)c[a]=g.val[a]/g.sum*d,f[a]=harryTools.COLORS[a%harryTools.COLORS.length],j.push(e?
Math.round(100*g.val[a]/g.sum)+"%":g.val[a].toString())}var d=this.rx+Math.round(this.rw/2),e=this.ry+Math.round(this.rh/2),g=Math.min(this.rh/2,this.rw/2)-1,i=g+0.7*this.labels.fontpx,k,l=-Math.PI/2,h;this.gc.lineWidth=this.linewidth;this.gc.lineJoin="miter";for(a=0;a<b;a++)h=l+c[a],k=this.getGradient(f[a]),this.gc.beginPath(),this.gc.moveTo(d,e),this.gc.arc(d,e,g,l,h,!1),this.gc.closePath(),k&&(this.gc.fillStyle=k,this.gc.fill()),this.gc.strokeStyle=f[a],this.gc.stroke(),k=(l+h)/2,this.drawXLabel(j[a],
d+i*Math.cos(k),e+i*Math.sin(k),"center","middle"),l=h}return this},chart:function(a){var b=this.dlen;this.overpoints=[];if(b){var c,f,d=this.dataset[0].len,j=1<b?4:0,e=a?1:b,g=d&&b?(this.rw-j*(d-1))/d/e-1:0;0>g&&(g=0);var i,k,l,h=this.rx,m,n=a?this.dsum?this.rh/this.dsum:0:this.dmax?this.rh/this.dmax:0;this.gc.lineWidth=this.linewidth;this.gc.lineJoin="miter";for(f=0;f<b;f++)this.overpoints.push({x:[],y:[],v:[],nds:f});for(c=0;c<d;c++){this.drawXLabel(c,h+(g+1)*e/2,this.h-1);l=this.ry2;for(f=0;f<
b;f++){i=this.dataset[f];y0=a?l:this.ry2;l=y0-Math.round(n*i.val[c]);k=Math.round(h);m=Math.round(h+g);this.gc.beginPath();this.gc.moveTo(k,y0);this.gc.lineTo(k,l);this.gc.lineTo(m,l);this.gc.lineTo(m,y0);this.gc.closePath();if(k=this.getGradient(i.col))this.gc.fillStyle=k,this.gc.fill();this.gc.strokeStyle=i.col;this.gc.stroke();this.overpoints[f].x.push(0.5+Math.floor(h+g/2));this.overpoints[f].y.push(l);this.overpoints[f].v.push(i.val[c]);a||(h+=g+1)}h+=a?g+1+j:j}}return this},chartOver:function(a,
b){return this.lineOver(a,b)},curve:function(a){return this.line(a,!0)},curveOver:function(a,b,c){return this.lineOver(a,b,c,!0)},line:function(a,b){var c=this.dlen,f=a?this.dsum?this.rh/this.dsum:0:this.dmax?this.rh/this.dmax:0,d,j,e,g,i;this.gc.lineWidth=this.linewidth;this.gc.lineJoin=this.linejoin;for(this.overpoints=[];d=this.dataset[--c];)if(1<(i=d.val.length)){var k,l,h=[],m=[];for(e=0;e<i;++e){g=0;if(a)for(j=0;j<=c;j++)g+=this.dataset[j].val[e];else g=d.val[e];h.push(this.rx+Math.round(e*
(this.rw/(i-1))));m.push(this.ry2-Math.round(f*g))}this.overpoints.push({x:h,y:m,v:this.dataset[c].val,nds:c});e--;h.push(this.rx+Math.round(e*(this.rw/(i-1))));m.push(this.ry2-Math.round(f*g));if(j=this.getGradient(d.col)){this.gc.beginPath();this.gc.moveTo(this.rx,this.ry2);this.gc.lineTo(h[0],m[0]);if(b)for(e=1;e<=i;++e)k=(h[e-1]+h[e])/2,l=(m[e-1]+m[e])/2,this.gc.quadraticCurveTo(h[e-1],m[e-1],k,l);else for(e=0;e<i;++e)this.gc.lineTo(h[e],m[e]);this.gc.lineTo(this.rx2,this.ry2);this.gc.closePath();
this.gc.fillStyle=j;this.gc.fill()}this.gc.strokeStyle=d.col;this.gc.beginPath();this.gc.moveTo(h[0],m[0]);0==c&&this.drawXLabel(0,h[0],this.h);if(b)for(e=1;e<=i;++e)k=(h[e-1]+h[e])/2,l=(m[e-1]+m[e])/2,this.gc.quadraticCurveTo(h[e-1],m[e-1],k,l),0==c&&e<i&&this.drawXLabel(e,h[e],this.h);else for(e=1;e<=i;++e)this.gc.lineTo(h[e-1],m[e-1]),0==c&&e<i&&this.drawXLabel(e,h[e],this.h);this.gc.stroke();if(this.radiuspoint){this.gc.fillStyle=d.col;for(e=0;e<i;++e)void 0!=d.val[e]&&(this.gc.beginPath(),this.gc.arc(h[e],
m[e],this.radiuspoint,0,2*Math.PI),this.gc.closePath(),this.gc.fill())}}return this},lineOver:function(a,b){var c,f=!1,d,j,e=this.mouseover.linewidth||1;if(this.overpoints.length){d=this.overpoints[0];for(c=0;c<d.x.length;++c)if(void 0!=d.v[c]&&(Math.abs(a-d.x[c])<j||!1===f))j=Math.abs(a-d.x[c]),f=c;if(!1!==f)for(c=0;c<this.overpoints.length;++c)if(d=this.overpoints[c],void 0!=d.v[f]){this.gc.beginPath();this.gc.lineWidth=e;this.gc.arc(d.x[f],d.y[f],this.mouseover.radius,0,2*Math.PI);0==this.mouseover.linewidth?
(this.gc.fillStyle=this.mouseover.circle,this.gc.fill()):(this.gc.strokeStyle=this.mouseover.circle,this.gc.stroke());if(this.mouseover.axis){this.gc.lineWidth=1;if(/x/i.test(this.mouseover.axis)){for(b=d.y[f]+this.mouseover.radius;b<this.ry2;)this.gc.moveTo(d.x[f],b),b+=2,b>this.ry2&&(b=this.ry2),this.gc.lineTo(d.x[f],b),b+=2;this.gc.stroke()}if(/y/i.test(this.mouseover.axis)){for(a=d.x[f]+this.mouseover.radius;a<this.rx2;)this.gc.moveTo(a,d.y[f]),a+=2,a>this.rx2&&(a=this.rx2),this.gc.lineTo(a,d.y[f]),
a+=2;this.gc.stroke()}}this.drawBullet(d.x[f],d.y[f],3+this.mouseover.radius,d.v[f],f,d.nds)}}},getFillMode:function(){return"a"==this.fill?(this.opacity=1,/\:river/.test(this.mode)?"v":/line/.test(this.mode)||/curve/.test(this.mode)?1<this.dlen?"n":"v":/chart/.test(this.mode)?1<this.dlen?"s":"v":/pie/.test(this.mode.test)?"r":"s"):this.fill},getGradient:function(a){var b=!1;switch(this.getFillMode()){case "s":b=harryTools.calcColor(a,21,this.opacity);break;case "v":b=this.gc.createLinearGradient(0,
this.ry2,0,this.ry);b.addColorStop(0,harryTools.calcColor(a,-48,this.opacity));b.addColorStop(1,harryTools.calcColor(a,48,this.opacity));this.gc.fillStyle=b;break;case "h":b=this.gc.createLinearGradient(this.rx,0,this.rx2,0);b.addColorStop(0,harryTools.calcColor(a,-48,this.opacity));b.addColorStop(1,harryTools.calcColor(a,48,this.opacity));this.gc.fillStyle=b;break;case "r":b=this.gc.createRadialGradient(this.rx2,this.ry2,0,this.rx,this.ry2,1),b.addColorStop(1,harryTools.calcColor(a,-48,this.opacity)),
b.addColorStop(0,harryTools.calcColor(a,48,this.opacity)),this.gc.fillStyle=b}return b}};var plotter=function(a){return new harry(a)};