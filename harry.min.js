...
e;++d){h=A+Math.round(J*s.x[d]/100);a.beginPath();a.moveTo(h,Q);a.lineTo(h,r);a.stroke()}}if(s.y){d=0;for(e=s.y.length;d<e;++d){h=r-Math.round(D*s.y[d]/100);a.beginPath();a.moveTo(A,h);a.lineTo(K,h);a.stroke()}}}if(z&&i.y&&/chart|line|curve/.test(u)){var d=/\:[r|s]/.test(u)?F:I,f,k,m,n=d<10?100:d<100?10:1,o=Math.floor(i.fontpx/2.5);L(i.shadow);a.font=i.font;a.fillStyle=i.color;e=0;for(h=i.y.length;e<h;++e){k=r-Math.round(D*i.y[e]/100);m=Math.round(n*d*i.y[e]/100)/n;if(/right/i.test(i.ypos)){f=K+1;
a.textAlign="left";a.fillText(m,f,k+o)}if(/left/i.test(i.ypos)){f=A-2;a.textAlign="right";a.fillText(m,f,k+o)}}M()}if(C&&C.z=="top"){fa[g](c);pa()}else{pa();fa[g](c)}if(v!==false&&z>1){a.save();a.font=v.font;m=0;e=O(v.font)+3;h=e-3;f=z;o=3+e*f;k=v.x;for(var w=v.y,d=0;d<f;++d)if((n=a.measureText(q[d].tit)).width>m)m=n.width;n=9+h+m;a.lineWidth=1;if(m=v.background){L(v.shadowbox);a.fillStyle=m;a.fillRect(k,w,n,o);M()}if(m=v.border){a.strokeStyle=m;a.strokeRect(k,w,n,o)}d=0;for(n=w+3;d<f;++d,n=n+e){o=
